...
def load_data():
    ...
    dem_df = pd.read_csv('/mnt/user-data/uploads/Dem_assembly_press_09012025.csv')
    dem_df['party'] = 'Democratic'
    
    # Load Republican data
    rep_df = pd.read_csv('/mnt/user-data/uploads/Rep_asm_press_09052025.csv')
...
def create_visualizations(results, output_dir='/home/claude'):
...
def main():
    ...
    results['all_df'].to_csv('/home/claude/analyzed_press_releases.csv', index=False)
    print("\nAnalyzed data saved to analyzed_press_releases.csv")
